...
urlpatterns = [
    ...
    path(
        "revisiones/<int:ficha_id>/",
        ReviewerFichaDetailView.as_view(),
        name="revisor_ficha",
    ),

    # APIs revisión de documentos / ficha
    path(
        "api/document/<int:doc_id>/review/",
        ReviewDocumentUpdateView.as_view(),
        name="api_review_document",
    ),
    path(
        "api/ficha/<int:ficha_id>/approve/",
        ApproveFichaView.as_view(),
        name="api_approve_ficha",
    ),
    path(
        "api/ficha/<int:ficha_id>/observe/",
        ObserveFichaView.as_view(),
        name="api_observe_ficha",
    ),
    path(
    ...
    path(
        ...
        name="api_update_user_name",   # ← AQUÍ EL CAMBIO
    ),
    path(
        "api/delete-user/",
    ...
    path(
        "api/soporte/ticket/<int:pk>/",
        supportticket_detail_api,
        name="supportticket_detail_api",
    ),
    path(
        "api/soporte/ticket/<int:pk>/responder/",
        supportticket_reply,
